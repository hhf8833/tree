package com.hhf.treeblocknode.util;
...
public class ECCUtils {
    ...
    public static String geneateSignature(String data){
        return null;
    }
     ...
     */
    public String geneateSignature(String plainText, String prvKey) throws NoSuchAlgorithmException, InvalidKeySpecException,
            InvalidKeyException, SignatureException {
        String algorithm = GMObjectIdentifiers.sm2sign_with_sm3.toString();//使用的签名规则
        BouncyCastleProvider bc = new BouncyCastleProvider();
        Signature signature = Signature.getInstance(algorithm,bc);// 创建签名对象
        // 将私钥HEX字符串转换为X值
        BigInteger bigInteger = new BigInteger(prvKey, 16);
        BCECPrivateKey privateKey = (BCECPrivateKey) keyFactory.generatePrivate(new ECPrivateKeySpec(bigInteger,
                ecParameterSpec));
...
//    public String geneateSignature(String message, String prvKey) throws Exception {
//        String algorithm = GMObjectIdentifiers.sm2sign_with_sm3.toString();//使用的签名规则
//        BouncyCastleProvider bc = new BouncyCastleProvider();
//        Signature signature = Signature.getInstance(algorithm,bc);// 创建签名对象
//        KeyPair priKey = ECCCUtils.getPrivate();// 获取密钥
//        signature.initSign(priKey);// 利用私钥对签名进行初始化
//        // 传入签名字节
//        signature.update(message.getBytes());
//        // 签名
//        Base64.Encoder encoder = Base64.getEncoder();
//        String signedMessage = encoder.encodeToString(signature.sign());
...
//    }
    ...
    public static void main(String[] args) throws InvalidAlgorithmParameterException, NoSuchAlgorithmException {
        ...
        try {
            ...
            String signStr = sm2.geneateSignature(str, prvKey);
